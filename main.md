...
|---|---|---|
| *(Your Name)* | Backend Lead | FastAPI, PostgreSQL, Analytics Engine, Gemini Integration, Render Deployment |
| *(Your Name)* | Frontend Lead | Next.js Dashboard, Recharts, Shadcn/ui, Vercel Deployment |
| *(Your Name)* | Designer | Figma Design System, Pitch Deck, Business Model Canvas, UI Polish |
| *(Your Name)* | Presenter | Problem Narrative, BMC, Judge Q&A Preparation, Live Demo |
...
*"IIROS is production-ready today, IoT-ready tomorrow, and Nepal-ready always."*

**Built with purpose. Deployed with confidence.**

---

*Made with ❤️ for Nepal's institutions*
